...
(defn build-grid
  ...
  (process-grid table)
  (println (str "Code generated here: src/sk/handlers/admin/" table)))
;; End build-grid
...
(defn build-dashboard
  ...
  (println (str "Code generated here: src/sk/handlers/" table)))
;; End build-dashboard
...
(defn build-report
  ...
  (build-report-skeleton
   {:folder table
    ...
    :root "src/sk/handlers/reports/"})
  (process-report table)
  (println (str "Code generated here: src/sk/handlers/reports/" table)))
;; End build-report
